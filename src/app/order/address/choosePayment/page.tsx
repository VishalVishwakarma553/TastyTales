...
const ChoosePayment = (props: Props) => {
  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-5 mx-2 sm:mx-6'>
      <div className='sm:col-span-2'>
        ...
        <div className="flex items-center space-x-2 p-4 bg-green-50 border border-green-200 rounded-lg">
          ...
          <div className='flex justify-between items-center w-full'>
            ...
            <Button className='text-blue-900 hover:bg-blue-400/20 cursor-pointer bg-blue-400/10 border-blue-500 hover:scale-95'>Change</Button></Link>
          </div>
        </div>
        ...
        className="mt-4 p-4 border rounded-lg">
          <div className='flex justify-between items-center flex-wrap '>
            <h3 className="text-lg text-slate-800 font-semibold mb-4">Select Payment Option</h3>
            <div className='mb-2'>
